...
@tool
@icon("res://roulette_dungeon/play/player/player_assets/joystick_assets/joystick.png")
extends Control
...
func draw_debug() -> void:
	...
	draw_string(SystemFont.new(), string_pos, length_string, HORIZONTAL_ALIGNMENT_CENTER, -1.0, 18, lerped_color, int(get_weight()))
